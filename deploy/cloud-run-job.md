...
gcloud run jobs create music-assemble \
  ...
  --cpu 4 \
  --max-retries 0 \
  --set-env-vars "CLOUDFLARE_R2_BUCKET=your-bucket,CLOUDFLARE_R2_ENDPOINT=https://ACCOUNT.r2.cloudflarestorage.com,ASSEMBLY_CATEGORY=korean,THUMBNAIL_TEXT=OMYO,YOUTUBE_METADATA_PROVIDER=auto" \
